...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_INT_CONSTANT = 3,             /* T_INT_CONSTANT  */
  ...
  YYSYMBOL_T_SIZE = 9,                     /* T_SIZE  */
  YYSYMBOL_T_ERROR = 10,                   /* T_ERROR  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_my_start_sym = 12,              /* my_start_sym  */
  YYSYMBOL_misc_non_term_symbol = 13       /* misc_non_term_symbol  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_INT_CONSTANT",
  "T_PLUS", "T_MINUS", "T_MULTIPLY", "T_DIVIDE", "T_PRINT", "T_SIZE",
  "T_ERROR", "$accept", "my_start_sym", "misc_non_term_symbol", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* misc_non_term_symbol: T_INT_CONSTANT  */
#line 44 "rpn.y"
                     {  rpnstack.push(yylval); }
#line 1100 "rpn.tab.c"
    break;

  case 5: /* misc_non_term_symbol: T_PLUS  */
#line 45 "rpn.y"
             { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a+b);}
#line 1106 "rpn.tab.c"
    break;

  case 6: /* misc_non_term_symbol: T_MINUS  */
#line 46 "rpn.y"
              { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a-b);}
#line 1112 "rpn.tab.c"
    break;

  case 7: /* misc_non_term_symbol: T_MULTIPLY  */
#line 47 "rpn.y"
                 { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a*b);}
#line 1118 "rpn.tab.c"
    break;

  case 8: /* misc_non_term_symbol: T_DIVIDE  */
#line 48 "rpn.y"
               { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a/b);}
#line 1124 "rpn.tab.c"
    break;

  case 9: /* misc_non_term_symbol: T_PRINT  */
#line 49 "rpn.y"
              { if(stack_error(1)) break; cout << rpnstack.top() << endl; rpnstack.pop(); }
#line 1130 "rpn.tab.c"
    break;

  case 10: /* misc_non_term_symbol: T_SIZE  */
#line 50 "rpn.y"
             { cout << "stack=" << rpnstack.size() << endl; }
#line 1136 "rpn.tab.c"
    break;

  case 11: /* misc_non_term_symbol: T_ERROR  */
#line 51 "rpn.y"
